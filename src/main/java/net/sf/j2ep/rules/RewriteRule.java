...
public class RewriteRule extends BaseRule {
    ...
    public RewriteRule() {
        isRewriting = false;
        log = LoggerFactory.getLogger(RewriteRule.class);
    }
    ...
    public String process(String uri) {
        ...
        if (isRewriting) {
            ...
            if (log.isDebugEnabled()) log.debug("Rewriting URI: " + uri + " >> " + rewritten);
        }
        return rewritten;
    }
    ...
    public String revert(String uri) {
        ...
        if (isReverting) {
            ...
            if (log.isDebugEnabled()) log.debug("Reverting URI: " + uri + " >> " + rewritten);
        }
        return rewritten;
    }
